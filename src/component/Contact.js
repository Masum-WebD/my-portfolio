  ...
  return (
    <div id="contact">
      ...
      <div className=" grid place-items-center lg:grid-cols-2 sm:grid-cols-1 gap-3 mt-20">
        <form
          action="https://formsubmit.co/418f72ce2a407f47a997379cc0d79f67 "
          method="POST"
        >
          <input
            type="hidden"
          ...
          <br />
          <input
            className="rounded h-10 w-[260px]"
            type="text"
          ...
          <br />
          <input
            className="mb-2 h-10 w-[260px] rounded"
            type="email"
            name="email"
          ...
          ></textarea>
          <br />
          <button className="btn btn-primary text-xl font-bold px-10">
            Send
          </button>
        </form>
        <div className="mt-20">
          ...
          <p className="text-white text-xl mb-7">
            +8801860871112{" "}
            <span className="text-slate-500">(Always Available) </span>
          </p>
        </div>
      </div>
    </div>
