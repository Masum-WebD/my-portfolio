...
const Footer = () => {
  return (
    <footer class="mt-10 footer items-center p-4 bg-neutral text-neutral-content ">
      ...
      <div class="items-center ml-20 grid-flow-col">
        <p>Copyright © 2022 - Masum_Web Developer</p>
      </div>
      <div class=" mr-20 flex gap-4 md:place-self-center md:justify-self-end">
        <a href="https://www.linkedin.com/in/md-masum-rana-a87195222/" target="_blank">
