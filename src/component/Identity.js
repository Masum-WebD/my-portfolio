    ...
    return (
        <div className='px-32 mt-20'>
            ...
            <div className='mt-10'>
                ...
                <h2 className='text-1xl font-bold'>Front End Developer || Web developer || React Developer</h2>
                <div className='mt-5'>
                <Link to='' className='bg-[#FF87B7] text-black px-4 py-3 rounded mr-1  font-bold'>GET RESUME</Link>
